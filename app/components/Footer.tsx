...
export default function Footer() {
  return (
    <footer className="relative border-t border-[rgba(255,255,255,0.06)] bg-[#050510]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-[220px]">
              The AI platform built for the next generation of software.
            </p>
            {/* Social links */}
            <div className="flex gap-3 mt-5">
              {[
                ...
                <Link
                  key={social.label}
                  href="#"
                  className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-gray-500 hover:text-white hover:bg-white/[0.08] transition-all"
